 ...
 * @{
 */
#define PAL_GD32_CTL_MASK             (3U << 0U)
#define PAL_GD32_CTL_INPUT            (0U << 0U)
#define PAL_GD32_CTL_OUTPUT           (1U << 0U)
#define PAL_GD32_CTL_ALTERNATE        (2U << 0U)
#define PAL_GD32_CTL_ANALOG           (3U << 0U)

#define PAL_GD32_OMODE_MASK               (1U << 2U)
#define PAL_GD32_OMODE_PUSHPULL           (0U << 2U)
#define PAL_GD32_OMODE_OPENDRAIN          (1U << 2U)

#define PAL_GD32_OSPD_MASK               (1U << 3U)
#define PAL_GD32_OSPD_2M                 (0U << 3U)
#define PAL_GD32_OSPD_2M                 (0U << 3U)
#define PAL_GD32_OSPD_10M                (1U << 3U)

#define PAL_GD32_PUD_MASK              (3U << 5U)
#define PAL_GD32_PUD_FLOATING          (0U << 5U)
#define PAL_GD32_PUD_PULLUP            (1U << 5U)
#define PAL_GD32_PUD_PULLDOWN          (2U << 5U)
 ...
 */
#define PAL_MODE_ALTERNATE(n)           (PAL_GD32_CTL_ALTERNATE |         \
 ...
 */
#define PAL_MODE_RESET                  PAL_GD32_CTL_INPUT
 ...
 */
#define PAL_MODE_INPUT                  PAL_GD32_CTL_INPUT

/**
 * @brief   Input pad with weak pull up resistor.
 */
#define PAL_MODE_INPUT_PULLUP           (PAL_GD32_CTL_INPUT |             \
                                         PAL_GD32_PUD_PULLUP)

/**
 * @brief   Input pad with weak pull down resistor.
 */
#define PAL_MODE_INPUT_PULLDOWN         (PAL_GD32_CTL_INPUT |             \
                                         PAL_GD32_PUD_PULLDOWN)

/**
 * @brief   Analog input mode.
 */
#define PAL_MODE_INPUT_ANALOG           PAL_GD32_CTL_ANALOG

/**
 * @brief   Push-pull output pad.
 */
#define PAL_MODE_OUTPUT_PUSHPULL        (PAL_GD32_CTL_OUTPUT |            \
                                         PAL_GD32_OMODE_PUSHPULL)

/**
 * @brief   Open-drain output pad.
 */
#define PAL_MODE_OUTPUT_OPENDRAIN       (PAL_GD32_CTL_OUTPUT |            \
                                         PAL_GD32_OMODE_OPENDRAIN)
/** @} */
/*===========================================================================*/
