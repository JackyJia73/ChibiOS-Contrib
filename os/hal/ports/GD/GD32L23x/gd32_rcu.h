...
/**
 * @file    GD32L23x/gd32_rcu.h
 * @brief   RCU helper driver header.
 * @note    This file requires definitions from the ST header file
 *          @p gd32l23x.h.
 *
 * @addtogroup GD32L23x_RCU
 * @{
 */
 ...
 * @api
 */
#define rcuEnableADC(lp) rcuEnableAPB2(RCU_APB2EN_ADCEN, lp)
 ...
 * @api
 */
#define rcuDisableADC() rcuDisableAPB2(RCU_APB2EN_ADCEN)
 ...
 * @api
 */
#define rcuResetADC() rcuResetAPB2(RCU_APB2RST_ADCRST)
/** @} */
 ...
 * @api
 */
#define rcuEnableBKPInterface(lp) rcuEnableAPB1((RCU_APB1EN_BKPEN), lp)
 ...
 * @api
 */
#define rcuDisableBKPInterface() rcuDisableAPB1(RCU_APB1EN_BKPEN)
 ...
 */
/**
 * @brief   Enables the CAN peripheral clock.
 * @note    The @p lp parameter is ignored in this family.
 *
 * @param[in] lp        low power enable flag
 *
 * @api
 */
#define rcuEnableCAN(lp) rcuEnableAPB1(RCU_APB1EN_CANEN, lp)

/**
 * @brief   Disables the CAN peripheral clock.
 *
 * @api
 */
#define rcuDisableCAN() rcuDisableAPB1(RCU_APB1EN_CANEN)

/**
 * @brief   Resets the CAN peripheral.
 *
 * @api
 */
#define rcuResetCAN() rcuResetAPB1(RCU_APB1RST_CANRST)
/** @} */
 ...
 * @api
 */
#define rcuEnableDMA(lp) rcuEnableAHB(RCU_AHBEN_DMAEN, lp)
 ...
 * @api
 */
#define rcuDisableDMA() rcuDisableAHB(RCU_AHBEN_DMAEN)
 ...
 * @api
 */
#define rcuEnableI2C2(lp) rcuEnableAPB1(RCU_APB1EN_I2C2EN, lp)
 ...
 * @api
 */
#define rcuDisableI2C2() rcuDisableAPB1(RCU_APB1EN_I2C2EN)
 ...
 * @api
 */
#define rcuResetI2C2() rcuResetAPB1(RCU_APB1RST_I2C2RST)
/** @} */
 ...
 * @api
 */
#define rcuEnableTIM8(lp) rcuEnableAPB2(RCU_APB2EN_TIMER8EN, lp)
 ...
 * @api
 */
#define rcuDisableTIM8() rcuDisableAPB2(RCU_APB2EN_TIMER8EN)
 ...
 * @api
 */
#define rcuResetTIM8() rcuResetAPB2(RCU_APB2RST_TIMER8RST)
 ...
 * @api
 */
#define rcuEnableTIM11(lp) rcuEnableAPB1(RCU_APB1EN_TIMER11EN, lp)
 ...
 * @api
 */
#define rcuDisableTIM11() rcuDisableAPB1(RCU_APB1EN_TIMER11EN)
 ...
 * @api
 */
#define rcuResetTIM11() rcuResetAPB1(RCU_APB1RST_TIMER11RST)
 ...
 * @api
 */
#define rcuEnableTIM14(lp) rcuEnableAPB2(RCU_APB2EN_TIMER14EN, lp)
 ...
 * @api
 */
#define rcuDisableTIM14() rcuDisableAPB2(RCU_APB2EN_TIMER14EN)
 ...
 * @api
 */
#define rcuResetTIM14() rcuResetAPB2(RCU_APB2RST_TIMER14RST)

/**
 * @brief   Enables the TIM40 peripheral clock.
 *
 * @param[in] lp        low power enable flag
 *
 * @api
 */
#define rcuEnableTIM40(lp) rcuEnableAPB2(RCU_APB2EN_TIMER40EN, lp)

/**
 * @brief   Disables the TIM40 peripheral clock.
 *
 * @api
 */
#define rcuDisableTIM40() rcuDisableAPB2(RCU_APB2EN_TIMER40EN)

/**
 * @brief   Resets the TIM40 peripheral.
 *
 * @api
 */
#define rcuResetTIM40() rcuResetAPB2(RCU_APB2RST_TIMER40RST)
/** @} */
...
/**
 * @name    USBD peripheral specific RCU operations
 * @{
 */
/**
 * @brief   Enables the USBD peripheral clock.
 *
 * @param[in] lp        low power enable flag
 *
 * @api
 */
#define rcuEnableUSB(lp) rcuEnableAPB1(RCU_APB1EN_USBDEN, lp)

/**
 * @brief   Disables the USBD peripheral clock.
 *
 * @api
 */
#define rcuDisableUSB() rcuDisableAPB1(RCU_APB1EN_USBDEN)

/**
 * @brief   Resets the USBD peripheral.
 *
 * @api
 */
#define rcuResetUSB() rcuResetAHB(RCU_APB1RST_USBDRST)
/** @} */
